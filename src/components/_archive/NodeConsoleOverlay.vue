<template>
  <div v-if="node" class="console-overlay glass-panel" :class="{ 'is-fullscreen': isFullscreen }" @mousedown.stop @touchstart.stop>
...
function handleEditorMount(editor: any, monaco: any) {
  ...
  providerDisposable = monaco.languages.registerCompletionItemProvider(['python', 'javascript', 'markdown', 'json'], {
    ...
    provideCompletionItems: (model: any, position: any) => {
      ...
      const suggestions = nodes.value.map(n => {
        let title = n.id;
        try {
...
.console-overlay {
  ...
  /* Glassmorphism handled by .glass-panel utility */
  display: flex;
