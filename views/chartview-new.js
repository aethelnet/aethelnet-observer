...
class ChartView {
        ...
        this.container.innerHTML = `
            <div id="app">
                ...
                <div class="nav" style="position: fixed; top: 10px; right: 10px; z-index: 10000; background: rgba(0,0,0,0.8); padding: 10px; border-radius: 8px; border: 1px solid rgba(74, 222, 128, 0.3); pointer-events: auto;">
                    <a href="#dashboard" style="margin-right: 10px; pointer-events: auto; position: relative; z-index: 10001;">Dashboard</a>
                    <a href="#scanner" style="margin-right: 10px; pointer-events: auto; position: relative; z-index: 10001;">Scanner</a>
                    <a href="#opportunities" style="margin-right: 10px; pointer-events: auto; position: relative; z-index: 10001;">Opportunities</a>
                    <a href="#prophecy" style="margin-right: 10px; pointer-events: auto; position: relative; z-index: 10001;">PROPHECY</a>
                    <a href="#analytics" style="pointer-events: auto; position: relative; z-index: 10001;">Analytics</a>
                </div>
    ...
    updatePhysicsFactorsDisplay() {
        ...
        grid.innerHTML = factors.map(factor => {
            const value = this.controlDeckState.physics[factor.key] || 0;
            return `
